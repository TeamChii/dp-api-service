...
type MerchantModel struct {
	Data []entity.MerchantEntity `json:"data"`
}

/*type MerchantPhoneReq struct {
	User_phone string `json:"user_phone"`
}*/
type MerchantEntityResp struct {
	...
	PackageEntity     *entity.PackageEntity `gorm:"column:package_id;ForeignKey:package_id;AssociationForeignKey:package_id" json:"package"`
	Count_container   int                   `gorm:"column:-" json:"count_container"`
	//Image_ref         string                `gorm:"column:image_ref" json:"image_ref"`
	//Image_ref_id      int                   `gorm:"column:image_ref_id" json:"image_ref_id"`
	MerchantImageMapResp []MerchantImageMapResp `gorm:"-" json:"image"`
...
func (MerchantEntityResp) TableName() string {
	return "dp_ms_merchant"
}

type MerchantEntityReq struct {
	Mc_id             int        `gorm:"column:mc_id; primary_key" json:"mc_id"`
	Mc_name           string     `gorm:"column:mc_name" json:"mc_name"`
	Mc_email          string     `gorm:"column:mc_email" json:"mc_email"`
	Mc_email_ext      string     `gorm:"column:mc_email_ext" json:"mc_email_ext"`
	...
	Mc_district string `gorm:"column:mc_district" json:"mc_district"`
	Mc_postcode string `gorm:"column:mc_postcode" json:"mc_postcode"`
	Role_id     string `gorm:"-" json:"role_id"`
...
func (MerchantEntityReq) TableName() string {
	return "dp_ms_merchant"
}
